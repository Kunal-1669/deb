        ...
        >
          <div className="fixed inset-0 h-min min-h-full bg-boffwhite flex flex-col justify-between">
            <div
              ...
              className="w-full aspect-video bg-boffwhiteandblue"
            ></div>

            <div className="bg-[#fafaff] p-2 flex gap-2 shadow-sm select-none cursor-pointer relative group justify-between items-start">
              <div className="flex flex-col gap-y-0.5 items-start">
                <div className="flex gap-1 items-start">
                  ...
                  <span className="text-md text-bblue/[0.75] leading-none font-light">
                    per month
                  </span>
                </div>
              </div>
              <div>
                <button className="bg-sky-500 text-boffwhite font-bold font-[Inter] rounded-md px-10 py-3 leading-none">Start</button>
              </div>
            </div>
          </div>
        </Dialog>
